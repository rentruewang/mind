...
- Using contrasting (similar input, different output), contradictino (same input, different output), and common sense (hidden context) to showcase personality (here treated as a deterministic function).
