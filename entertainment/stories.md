...
- Spring & Autumn Brushwork: Hide subtlety in (many) details.
  ...
  7. Don't get fooled by the excuses / first person view
  8. Use _contrasting_ on real events outcome (compute "advantage" and disregard "baseline" to reveal delta), filter by similar events.
  9. Use _contradicting_ on real events outcome (shows that their must be extra factors at play), filter by character.
