...
01. Slower start makes timing window larger -> comeback possible because of larger window, not all about eco
02. Positional play is stronger -> player stays more on the map because (smaller groups of) units can defend themselves -> more skirmishes
03. Mobility worse -> positional play stronger
04. Less clump -> more plays because no balls and splash is weaker and terrain is more important -> scaling worse (also selection limit) -> comeback possible
05. More about throughput than latency -> longevity
06. Harder game -> more varied play style as players play differently (composition etc) -> every game is different
07. No instant death
08. Different maps
09. Map control needed to secure new bases, worker spread mechanic -> bases and spaces are important, not just workers
