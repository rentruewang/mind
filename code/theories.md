...
You can actually simultate dependent type in python, just your class has to store info in metaclass, or a local class from closure
...
FV is a superset of halting problem, can be undeidable in general.
...
From incomplete thoeorem: no consistent logical system can prove itself. lean cannot prove itself.
